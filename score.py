...
# this function is resposible for displaying the running score and total score on the  screen
# takes in the game state as a parameter 
...
# menu icons for various modes and levels 
    def start_display(self):
        ...
        self.menu_rect1 = self.menu1_surface.get_rect(center= (100,270)) 
        self.menu_rect2 = self.menu2_surface.get_rect(center= (300,270)) 
        self.menu_rect3 = self.menu3_surface.get_rect(center= (500,270)) 
        self.menu_rect4 = self.menu4_surface.get_rect(center= (200,370)) 
        self.menu_rect5 = self.menu5_surface.get_rect(center= (400,370)) 
        self.easymode_rect = self.easymode_surface.get_rect(center= (200,470))
        self.nmode_rect = self.nmode_surface.get_rect(center= (400,470)) 
...
# adds enlarging effect on menus when the mouse hovers 
